...
export default async function CourseBuilderPage({ params }: { params: { courseId: string } }) {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      ...
      <h1 className="mb-1 font-display text-2xl font-semibold">{course.title}</h1>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Title, description, university, and gating.</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <h2 className="mb-3 font-display text-xl font-semibold">Outline</h2>
